...
tools you will need the packages: *Biobase*, *annotate*, and
*geneplotter*. These must be installed in your version of R and when you
...
```{r echo=FALSE, fig.height=6, fig.width=6, message=FALSE, fig=TRUE}
cols <- dChip.colors(10)
...
```{r echo=FALSE, fig.height=6, fig.width=6, fig=TRUE}
par(mfrow=c(1,1)) 
