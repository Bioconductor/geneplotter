plotChr <- function(chrN, senseObj, 
    ...
    abline(h=0, col="gray")
    axis(1, at=at.nx, pos=0, tck=-0.01,col="gray", labels=F)
    axis(1, at=at.px, pos=0, tck=0.01,col="gray", las=3, labels=F)
    ...
    axis(3, at=repGx, labels=pn,tick=F, line=-1,cex.axis=.7)
